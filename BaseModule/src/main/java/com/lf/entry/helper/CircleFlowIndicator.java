...
//	private boolean mCentered = false;
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		radius = UnitConvert.DpToPx(getContext(), 4.0f);
		initColors(0xFFFF3333, 0xFFFF3333, STYLE_FILL, STYLE_STROKE);
	}
...
//				STYLE_FILL);
		int activeType = attrs.getAttributeIntValue("", "activeType", STYLE_FILL);
...
//						activeDefaultColor);
		int activeColor = attrs.getAttributeIntValue("", "activeColor", activeDefaultColor);
...
//				R.styleable.CircleFlowIndicator_inactiveType, STYLE_STROKE);
		int inactiveType = attrs.getAttributeIntValue("", "inactiveType", STYLE_FILL);

		int inactiveDefaultColor = 0x99FFFFFF;
		// Get a custom inactive color if there is one
//		int inactiveColor = a.getColor(
//				R.styleable.CircleFlowIndicator_inactiveColor,
//				inactiveDefaultColor);
		int inactiveColor = attrs.getAttributeIntValue("", "inactiveColor", inactiveDefaultColor);
