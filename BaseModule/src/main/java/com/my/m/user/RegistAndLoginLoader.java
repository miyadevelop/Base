...
/**
 * 注册并登录，如果已有账号，则登录，没有账号就创建
 * @author wangwei
 *
 */
public class RegistAndLoginLoader extends NetLoader{

	public RegistAndLoginLoader(Context context) {
		super(context);
	}
...
//				fileDataUtil.commit();
	...
	public DownloadCheckTask initDownloadTask() {
		...
		task.mIsSimple  = true;
		task.mUrl = Consts.getHost(getContext()) + "/mall/userRegisterAndLogin.json";
