...
// * @param <T>
// */
//public abstract class ComplexFenYeAdapter<T> extends BaseAdapter{
//
...
//
//	public ComplexFenYeAdapter(Context context, ArrayList<T> objects) {
//		super();
//		mContext = context;
...
//				row.setTag(mIndex++);
//				for(int i = 0; i < getItemColumnCount(type); i++)
//				{
//					int realPositon = position * getItemColumnCount(type) + i;
//					View itemView;
...
//	
//	
//	public int getItemColumnCount(int itemViewType)
//	{
//		return 1;
//	}
//
