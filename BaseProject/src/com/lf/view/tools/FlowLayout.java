...
public class FlowLayout extends RelativeLayout {
    ...
    // 关键字颜色
    private int textColor = getResources().getColor(R.color.button_2_text);
    // 关键字背景框
    private int backgroundResource = R.drawable.button_2_bg;
    // 关键字水平padding，单位为dp
    private int textPaddingH = dp2px(15);
    // 关键字竖直padding，单位为dp
    private int textPaddingV = dp2px(2);
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (attr == R.styleable.FlowLayoutAttrs_horizontalSpacing) {
                ...
                textColor = typedArray.getColor(attr, getResources().getColor(R.color.button_2_text));

            } else if (attr == R.styleable.FlowLayoutAttrs_backgroundResource) {
                backgroundResource = typedArray.getResourceId(attr, R.drawable.button_2_bg);

            } else if (attr == R.styleable.FlowLayoutAttrs_textPaddingH) {
                textPaddingH = typedArray.getDimensionPixelSize(attr, dp2px(15));

            } else if (attr == R.styleable.FlowLayoutAttrs_textPaddingV) {
                textPaddingV = typedArray.getDimensionPixelSize(attr, dp2px(2));
    ...
    public void setFlowLayout(List<String> list, final OnItemClickListener onItemClickListener) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            tv.setPadding(textPaddingH, textPaddingV  - dp2px(1), textPaddingH, textPaddingV);
