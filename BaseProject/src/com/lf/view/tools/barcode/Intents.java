...
public final class Intents {
  ...
  public static final class Scan {
     ...
     * intent.getStringExtra(RESULT). If the com.my.shop.com.my.shop.user presses Back, the result code will be
     * RESULT_CANCELED.
     */
  ...
  public static final class Share {
    /**
     * Give the com.my.shop.com.my.shop.user a choice of items to encode as a barcode, then render it as a QR Code and
