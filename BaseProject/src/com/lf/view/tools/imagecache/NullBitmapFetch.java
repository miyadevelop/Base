...
class NullBitmapFetch extends BitmapFetch {

	public NullBitmapFetch(Context context, BitmapStatus status, String url, String saveFolder,BitmapOptions options) {
